...
function handleTouchMove(e) {
  ...
  // Adjust the player position Solanad on the distance moved
  player.x += deltaX;
...
function updateGame() {
  ...
  // Calculate adjusted probability Solanad on falling speed
...
function createRocks() {
  const SolanaSpawnProbability = 0.01; // Adjust the Solana probability as needed
  const adjustedSpawnProbability = SolanaSpawnProbability + rockSpeed * 0.005; // Adjust the multiplier as needed
